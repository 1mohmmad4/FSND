...
class QuizView extends Component {
 ...
 getNextQuestion = () => {
  ...
  $.ajax({
   url: "/questions/quizzes", //TODO: update request URL
   type: "POST",
   dataType: "json",
   contentType: "application/json",
   data: JSON.stringify({
    previousQuestionIds: previousQuestions,
    category: this.state.quizCategory.type,
   }),
   xhrFields: {
   ...
   <div className="quiz-play-holder">
    ...
    <div className="category-holder">
     <div
      ...
      onClick={() => this.selectCategory({ type: null, id: 0 })}
     >
      ALL
     </div>
